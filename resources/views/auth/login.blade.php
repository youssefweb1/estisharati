...
@section('content')
    <div class="right h-full bg-white flex flex-col justify-center items-center max-w-sm ">
        <div class="w-right ">
            ...
            <form action="{{ route('login') }}" method="POST" class="flex flex-col items-end mx-auto w-full sm:mt-10 mt-0">
                @csrf

                <!-- username or email -->
                <div class="relative w-full mb-4">
                    <label for="username_or_email"
                        class="block mb-[3px] mr-3 sm:mr-5 text-right text-[#2A2A2A] sm:text-[17px] text-[15px] font-normal leading-normal">
                    ...
                    <input type="text" name="username_or_email" id="username_or_email" value="{{ old('username_or_email') }}"
                        ...
                        placeholder="أدخل إسم المستخدم أو البريد الإلكتروني" required />
                ...
                <a href="{{ route('password.reset') }}"
                    class="mr-5 text-right sm:text-[18px] text-[15px] font-normal text-[#6A6565]">نسيت كلمة
                    المرور؟</a>
            ...
            <p for="link-checkbox" class=" text-center sm:text-[18px] text-[15px] font-[500]  text-[#6A6565] my-10">
                ...
                <a href="{{ route('register') }}" class="mx-1 text-[#E77E5C] sm:text-[18px] text-[15px] font-[500] ">
                    انشاء حساب
                </a>
            </p>
