...
<body>
    <main>
        ...
        <div id="loader" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-[999999]">
            <span class="loader"></span>
        </div>


        <div
            class="flex  items-center justify-center lg:items-start lg:justify-start max-w-[120rem] mx-auto lg:bg-[#F5F5F5]">

            <div class="left h-full flex flex-col justify-center items-center gap-20 py-10 w-full ">
                <!-- title -->
                <div class="flex items-center gap-4">
                    ...
                    <span class="text-[#2A2A2A] text-center font-[500] text-[40px] leading-normal">
                        أهلا بك في إستشاراتي
                    </span>
                ...
                <div class="flex flex-col items-center justify-center">
                    <img src="{{ asset('assets/images/qrcodelogin.svg') }}" alt="" srcset="">
                    <p class="text-[#2A2A2A] mt-3 text-center font-[500] text-[27px] ">
            ...
            <div class="right h-full bg-white flex flex-col justify-center items-center max-w-sm ">
                <div class="w-right mt-8 pb-10">

                    @if (session('success'))
                        <div id="successAlert"
                            class="alert alert-success flex items-center p-4 mb-4 text-green-800 bg-green-100 rounded-lg"
                            role="alert">
